...
export const StackedBarChart = $((key) => {
	var d3 = require("d3");
	var svgContainer = d3
	...
	// 			(d) => d.grade
	// 		),
	// 		(values) => ({ score: values[0], grade: values[1], count: values[2] })
	// 	);
	// 	console.log(counts);
	...
	// 	console.log("Done Appending SVG");
	// })
	// .catch((reason) => {
	// 	console.log(reason);
	//
	//});
	return html`${eval(d3.select(".container").html())}`;
});
