...
import { scale_meanings, scale_wranglers } from "../constants";
import { table, scatterChart, stackedBarChart } from "./Charts";

const App = $(function () {
	const [page, setPage] = useState(0);

	const pages = Object.keys(scale_wranglers);

	return html` <div id="${pages[page]}" class="page">
		<h1>Mental Health Report for Resilient Youth Australia</h1>
		<h2>${pages[page].toUpperCase()} Overview</h2>
		<h3>${scale_meanings[pages[page]]}</h3>
